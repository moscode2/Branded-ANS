...
const inp = {
  ...
  padding: "12px 16px", fontSize: 14, width: "100%", outline: "none",
  borderRadius: 4, boxSizing: "border-box" as const, fontFamily: "inherit",
};
const lbl = {
  display: "block" as const, fontSize: "0.65rem", letterSpacing: "0.18em",
  textTransform: "uppercase" as const, color: "#7a9bb5", marginBottom: 8,
  fontFamily: "monospace", fontWeight: 600,
};
const box: React.CSSProperties = {
  background: "#0a0f1a", border: "1px solid #1a3a5c", borderRadius: 4, padding: 20,
};
...
export default function NewInsightPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    if (insertErr) { setError(insertErr.message); setSaving(false); }
    ...
    <AdminShell>
      <div style={{ maxWidth: 960 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 28 }}>
          <Link href="/admin/insights" style={{ color: "#7a9bb5", fontSize: 13, textDecoration: "none" }}>
            ← Insights
          </Link>
        ...
        {error && (
          <div style={{ marginBottom: 20, padding: "12px 16px", background: "rgba(248,113,113,0.08)", border: "1px solid rgba(248,113,113,0.2)", color: "#f87171", fontSize: 13, borderRadius: 4 }}>
            ⚠ {error}
            {(error.includes("body") || error.includes("cover") || error.includes("author")) && (
              <p style={{ marginTop: 6, fontSize: 11, color: "rgba(248,113,113,0.7)" }}>
                Run the ALTER TABLE migration in Supabase SQL Editor to add missing columns.
              </p>
            )}
          </div>
        )}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={box}>
                ...
                />
                {form.title && (
                  <p style={{ fontSize: 11, color: "#3d5a73", marginTop: 6, fontFamily: "monospace" }}>
                ...
                {form.cover_image && (
                  <div style={{ marginBottom: 12, position: "relative" }}>
                    <img
                      ...
                      style={{ width: "100%", height: 160, objectFit: "cover", borderRadius: 4, border: "1px solid #1a3a5c" }}
                    />
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={box}>
                ...
                <div>
                  ...
                  <input value={form.read_time} onChange={(e) => set("read_time", e.target.value)}
                    placeholder="8 min read" style={inp} />
                </div>
              </div>
              ...
              {form.title && (
                <div style={{ background: "rgba(0,212,255,0.04)", border: "1px solid rgba(0,212,255,0.1)", borderRadius: 4, padding: 14 }}>
                  <p style={{ fontSize: 11, fontWeight: 600, color: "#7a9bb5", marginBottom: 4, fontFamily: "monospace" }}>
                    Slug Preview
                  </p>
                  <p style={{ fontSize: 11, color: "#3d5a73", fontFamily: "monospace", wordBreak: "break-all" }}>
                    /insights/{slugify(form.title)}
                  </p>
                </div>
              )}
            </div>
